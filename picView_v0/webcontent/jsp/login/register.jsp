...
<body>
	...
	<div class="center">
		...
		<div class="contents">
			...
			<!-- 가입폼 -->
			<div id="center_left" class="col-xs-7 col-lg-7">
				<form class="form-horizontal" role="form" action="insertAction.do"
					method="post">
					...
					<div class="form-group">
						...
						<div class="col-xs-7 col-lg-7 col-sm-7">
							<input type="email" class="form-control "
								placeholder="이메일 형식의 아이디" name="email"> <span
			...
			<!-- 카테고리 -->
			<div id="center_right" class="row col-xs-4 col-lg-4">
					...
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/1art.jpg)"></div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/2trip.jpg)"></div>
							<div class="interestLabel">
								<h4>여행</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/3fashion.jpg)"></div>
							<div class="interestLabel">
								<h4>패션</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/4music.jpg)"></div>
							<div class="interestLabel">
								<h4>음악</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/5book.png)"></div>
							<div class="interestLabel">
								<h4>도서</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/6animal.jpg)"></div>
							<div class="interestLabel">
								<h4>동식물</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/7human.jpg)"></div>
							<div class="interestLabel">
								<h4>인물</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/8design.jpg)"></div>
							<div class="interestLabel">
								<h4>디자인</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/9issue.jpg)"></div>
							<div class="interestLabel">
								<h4>이슈</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/10food.jpg)"></div>
							<div class="interestLabel">
								<h4>음식</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/11sports.jpg)"></div>
							<div class="interestLabel">
								<h4>스포츠</h4>
							</div>
						</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="Interest Module FollowButton">
						...
						<div class="interestWrapper" style="background-color: #403F14">
							<div class="interestImage"
								style="background-image: url(../../images/category/12etc.jpg)"></div>
							<div class="interestLabel">
								<h4>기타</h4>
							</div>
						</div>
