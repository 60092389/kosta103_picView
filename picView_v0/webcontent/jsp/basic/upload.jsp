...
<link href="../../jsp/basic/css/upload2.css" rel="stylesheet">
...
<body>
	...
	<div class="contents">
		<form id="fileupload" name="uploadForm" action="fupload.po"
			...
			<div id="upload_select" class="row fileupload-buttonbar">
				<div id="upload_tool">
					...
					<span class="btn btn-success fileinput-button"> <i
						...
						type="file" id="test11" name="files[]" multiple="multiple">
					</span>
			...
			<div id="upload_area">
				<div class="table table-striped">
					<div id="picture_list" class="files"></div>
				</div>
			</div>
			...
			<div id="menu">
				<input class="form-control" placeholder="제목" name="title"
					id="form_title"> <input class="form-control"
					placeholder="설명" name="content"> <label>태그 추가</label> <input
					class="form-control" placeholder="태그를 컴마(,)로 분리" name="tag">
				...
				<div id="upload_btn" class="row fileupload-buttonbar">
					<div class="col-lg-7">
						<button type="submit" class="btn btn-primary start">
							<i class="glyphicon glyphicon-upload"></i> <span>업로드</span>
						</button>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <div id="upload_pic" class="template-upload fade">
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <div id="upload_pic" class="template-download fade">
