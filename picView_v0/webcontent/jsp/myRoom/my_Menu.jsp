		...
		<div id="profileBack" style="border: 2px solid blue">
			<div class="coverPhoto">
				<div class="coverPhoto-content fluid-centered">
					...
					<div class="avatar no-menu person large" style="background-image: url(//c1.staticflickr.com/1/724/buddyicons/136454064@N06_r.jpg?1443072667#136454064@N06); ">
						<div class="edit">
							<a href="#"><span class="glyphicon glyphicon-pencil edit-icon"></span></a>
						</div>
					</div>
