...
<link href="../../jsp/myRoom/css/my_Popular_Reply.css" rel="stylesheet">
</head>
<body>
	<div class="header">
	...
	<div id="myMenu_navi">
		<ul class="nav nav-pills">
			<li class="menu"><a href="my_Manage.jsp">사진 관리</a></li>
	...
	<div class="contents">
		<div id="pop_nav">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="my_Popular_Reply.jsp">댓글수</a></li>
			</ul>
		</div>
